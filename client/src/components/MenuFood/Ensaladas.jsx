...
export default function Ensaladas({ setCartItems, setShowSummary, setQuantities, quantities }) {
  ...
  const piqueos = restaurantdetails?.Menus.filter(menu => menu.category.includes("Ensaladas") && menu.stock === true)
      ...
      {piqueos?.length > 0 ? (
        <div className={styles.menufood_container}>
          <div className={styles.container_bg_none}>
            <h1 className={styles.title_Carrusel2}>Ensaladas</h1>
            <Splide
              options={{
                perPage: 4,
                perMove: 1,
