...
export default function Ensaladas({
  ...
  const piqueos = restaurantdetails?.Menus.filter(
    (menu) => menu.category.includes("Ensaladas") && menu.stock === true,
  );

  return (
    <div data-oid="02x.rqr">
      {piqueos?.length > 0 ? (
        <div className={styles.menufood_container} data-oid="ob4xoll">
          <div className={styles.container_bg_none} data-oid="tbt5.wk">
            <h1 className={styles.title_Carrusel2} data-oid="07.7gu.">
              Ensaladas
            </h1>
            <Splide
              options={{
            ...
            >
              {piqueos.map((data) => (
                <SplideSlide key={data.id} data-oid="wcr9jz:">
                  <Card className={styles.card} data-oid="1jt5lh4">
                    <CardMedia
                      component="img"
                    ...
                    <Box
                      ...
                      data-oid="r1rqr7k"
                    >
                      <CardContent sx={{ flex: "1 0 auto" }} data-oid="b0ksg87">
                        <Typography
                          component="div"
                          variant="h5"
                          data-oid="i5-lijp"
          ...
          <Modal
            ...
            data-oid="ytyfqm1"
          >
            <Box sx={modalStyle} data-oid="pbjt29:">
              {/* Botón de cierre */}
              <IconButton
                onClick={handleClose}
                sx={{
              ...
              >
                {selectedImages.map((image, index) => (
                  <SplideSlide key={index} data-oid="dlmi.w5">
                    <img
                      src={image}
                      alt={selectedName}
                      style={{
